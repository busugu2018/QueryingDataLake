...
* **AWS Lambda** generates simulated credit card transaction data: I ran an AWS Lambda function to generate a text file of fake credit card transactions.
* **Amazon S3** stores the transaction files as the data lake.
* **Amazon Athena** queries the data directly from S3 using SQL: I created an Amazon Athena table from the exported text file.
* SQL queries identify transactions matching potential fraud indicators: I queried the table for suspected credit card transactions.
